...
class Feedbacks(models.Model):
    ...
    def __str__(self):
        ...
        return str(max(feedback_list, key=feedback_list.get))
...
class Tags(models.Model):
    product = models.ManyToManyField(Products, through="DiscountsTags")
...
class DiscountsTags(models.Model):
    discount = models.ForeignKey("Discounts", on_delete=models.CASCADE)
    tag = models.ForeignKey(Tags, on_delete=models.CASCADE)


class Discounts(models.Model):
    product = models.ManyToManyField(Products, through="DiscountsProducts")
...
class DiscountsProducts(models.Model):
    discount = models.ForeignKey(Discounts, on_delete=models.CASCADE)
